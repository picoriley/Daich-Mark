...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/daichmark-project/daichmark>";
    const std::string URL_WEBSITE = "<https://daichmark.org>";
