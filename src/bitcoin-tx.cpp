...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s daichmark-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  daichmark-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded daichmark transaction") + "\n" +
              "  daichmark-tx [options] -create [commands]   " + _("Create hex-encoded daichmark transaction") + "\n" +
              "\n";
