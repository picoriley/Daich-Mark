...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.daichmark.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.daichmarktools.com", true);
        vSeeds.emplace_back("dnsseed.daichmarkpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.daichmarktools.com", true);
        vSeeds.emplace_back("seed-b.daichmark.loshan.co.uk", true);
