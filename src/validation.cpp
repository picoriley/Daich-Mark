...
#if defined(NDEBUG)
# error "Daichmark cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Daichmark Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DCM additional fees, %d delta bytes\n",
